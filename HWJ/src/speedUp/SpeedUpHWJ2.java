...
public class SpeedUpHWJ2 {
	...
	public static void speedUpTest(int lower, int higher, int lowerNB, int higherNB) {
		...
		int i;
		BinaryTreeAdder treeSerial = new BinaryTreeAdderHWJ2(1, 2000); //seriale (con 1 cpu)
		BinaryTreeAdder treeConcurrent = new BinaryTreeAdderHWJ2(numCPU, 2000); //concorrente
		System.out.println("SPEED UP DI HWJ2");
